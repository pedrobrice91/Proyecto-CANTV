...
<br  />
<h1 align="center"><font color="#2763A5"><u>Almacen de Activos</u></h1>
<font color="#2763A5"><hr width="80%" size="8" noshade></font>
<br  />
<center>
<form action="pro_buscar2.php" method="get">
<br /><br />
<input type="radio" name="buscar" id="buscar" value="1" checked="checked" /> Lista de Todos los Activos <br /><br />
<input type="radio" name="buscar" id="buscar" value="2" />Busqueda por Codigo de Inventario: <input type="text" name="cod_Inventario"  /><br /><br />
